...
% =========================================================================
function [m_struct,masses,thicknesses,velocities,polar]=StructureDesignerRibWing(b,AR,m_pld,m_distr,n,ismars)

%TODO this is cheating
mult = 1.21; %set to meet Siebenmanns calculations for 5.4m/AR19.6/mbat4kg plane with
%an additional 20% margin(meeting of 20120607). 
